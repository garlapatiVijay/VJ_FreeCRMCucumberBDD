...
public class TaggedHooksStepDefinition {
	...
	@Before(order=0)
	public void setUP(){
		System.out.println("Before Order = 0 launch FF");
		System.out.println("Enter URL for Free CRM APP");
	}

	@After(order=0)
	public void tearDown(){
		System.out.println(" After Order =0 close the browser");
	}
	
	@Before(order=1)
	public void setUP1(){
		System.out.println(" Before Order = 1 launch FF");
		System.out.println("Enter URL for Free CRM APP");
	}

	@After(order=1)
	public void tearDown1(){
		System.out.println("After Order =1 close the browser");
	}
